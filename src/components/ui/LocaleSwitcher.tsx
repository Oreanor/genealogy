...
export function LocaleSwitcher() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          className="absolute left-0 bottom-full mb-2 z-10 w-9 rounded-xl border border-(--border) bg-(--surface) p-2 shadow-xl md:bottom-auto md:top-full md:mb-0 md:mt-2 md:w-11"
          role="listbox"
